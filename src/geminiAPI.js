  ...
  contents: [
    {
      parts: [
        ...
        - Don't give a descriptive commit message for a short commit message, it should be in a single line and vice versa, make sure of the full stops in between sentences.
